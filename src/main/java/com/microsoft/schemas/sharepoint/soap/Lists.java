 ...
 * 
 */
@WebServiceClient(name = "Lists", targetNamespace = "http://schemas.microsoft.com/sharepoint/soap/", wsdlLocation = "file:/C:/wsdl%20sharepoint/lists.wsdl")
public class Lists
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/wsdl%20sharepoint/lists.wsdl");
